...
export class DetailsPage implements OnInit {
  ...
  constructor(private activedRoute: ActivatedRoute, private personaService:PersonaService,
  ...
  add(){
    ...
    this.showToast('Gracias te mantendremos informado');
    }, err=>{
      this.showToast("Hay un problema en Agregar");
    })
  }
  /* delete(){
